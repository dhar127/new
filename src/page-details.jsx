...
window.ViolationDetailPage = function({ violationId, onNavigate, inline, onBack }) {
  ...
  const details = useMemo(() => {
    ...
    const reasonFlagged = `Scanned authorization profiles contain transaction access mapping directly to conflict code ${finding.id || finding.riskId || violationId} (${tcodes.join(' × ')}).`;
